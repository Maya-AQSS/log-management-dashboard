...
function writeFiltersToUrl(filters: LogsFiltersState,
 sortBy: LogsSortKey | null,
 sortDir: SortDir | null,
 page: number,
): URLSearchParams {
...
function toApiFilters(filters: LogsFiltersState,
 sortBy: LogsSortKey | null,
 sortDir: SortDir | null,
 page: number,
): ApiLogsFilters {
...
export function LogsPage() {
 ...
 const updateFilters = useCallback((patch: Partial<LogsFiltersState>) => {
 ...
 {state.status ==='error' && (<Alert tone="danger" className="mt-4">{t('loadError', { message: state.error })}
 </Alert>
 )}
