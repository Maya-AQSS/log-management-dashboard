...
export function ErrorCodeCreatePage() {
 ...
 <div className="mt-4 rounded-lg border border-outline bg-surface-container-low p-4">
 <ErrorCodeForm
 value={form}
 ...
 <Link
 to="/error-codes"
 className="inline-flex items-center bg-transparent text-on-surface-variant border border-outline hover:text-on-surface hover:border-on-surface-variant px-4 py-1.5 rounded-md text-sm font-semibold transition-colors cursor-pointer"
 >
 Cancelar
 </Link>
