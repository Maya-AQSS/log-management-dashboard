...
FRONTEND_URL="http://logs.maya.test"
BACKEND_API_URL="http://logs-api.maya.test/api/v1"
DEFAULT_BACKEND_PORT="8002"
DEFAULT_FRONTEND_PORT="5176"

setup_frontend_env() {
    upsert_env_var frontend/.env VITE_API_URL            "${VITE_API_URL:-http://logs-api.maya.test/api/v1}"
