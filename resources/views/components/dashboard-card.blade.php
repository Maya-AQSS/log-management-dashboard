<a
    href="{{ $href }}"
    class="block rounded-2xl border {{ $borderClass }} {{ $backgroundClass }} min-h-44 p-6 shadow-sm ring-1 ring-black/5 transition hover:-translate-y-0.5 hover:shadow-md focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-odoo-purple dark:ring-white/10"
>
