<aside class="fixed inset-y-0 left-0 w-64 bg-ui-sidebar dark:bg-ui-dark-bg flex flex-col z-[100] border-r border-white/10 dark:border-ui-dark-border">
    ...
    <nav class="flex-1 py-3 px-2 space-y-0.5 overflow-y-auto">
        <a href="{{ route('dashboard') }}" class="{{ $linkClasses('dashboard*') }}">
        ...
        <a href="{{ route('logs.index') }}" data-nav="logs" class="{{ $linkClasses('logs*') }}">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-4 h-4 shrink-0">
        ...
        <a href="{{ route('archived-logs.index') }}" data-nav="archived-logs" class="{{ $linkClasses('archived-logs*') }}">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-4 h-4 shrink-0">
        ...
        <a href="{{ route('error-codes.index') }}" data-nav="error-codes" class="{{ $linkClasses('error-codes*') }}">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-4 h-4 shrink-0">
