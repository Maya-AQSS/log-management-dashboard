<x-layout>
    ...
    <form method="POST" action="{{ route('error-codes.store') }}" class="mt-4 bg-white border border-slate-200 rounded-2xl p-4 space-y-4 dark:bg-slate-900 dark:border-slate-700">
        @csrf
