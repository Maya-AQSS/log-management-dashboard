...
return [
    ...
    [
        'application_id' => 3,
        'code' => 'LAR-AUTH-001',
        'name' => 'Application create failed',
        'description' => 'Fallo al crear una aplicación desde el panel (persistencia o permiso view por defecto).',
    ],
    [
        'application_id' => 3,
        'code' => 'LAR-AUTH-002',
        'name' => 'Application update failed',
        'description' => 'Fallo al actualizar una aplicación desde el panel.',
    ],
    [
        'application_id' => 3,
        'code' => 'LAR-AUTH-003',
        'name' => 'Application delete failed',
        'description' => 'Fallo al eliminar (soft delete) una aplicación desde el panel.',
    ],
    [
        'application_id' => 3,
        'code' => 'LAR-AUTH-004',
