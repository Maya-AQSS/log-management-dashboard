...
| Backlog | Motivo |
| --- | --- |
| [F-00.2](F-00.2_migraciones_modelos.md) | Tabla `archived_logs` sin TTL definida en las migraciones |
| [F-05.1](F-05.1_conexion_postgresql.md) | Usuario BD con permisos mínimos (sin DELETE sobre `archived_logs`) configurado |
