...
return [
    ...
    | modificarlas según tus necesidades.
    |
    */
    ...
    | atributos usando la convención "attribute.rule" para nombrar las
    | líneas. Esto facilita la especificación de un mensaje específico.
    |
    */
    ...
    | de posición de atributo por algo más legible como "Dirección de correo
